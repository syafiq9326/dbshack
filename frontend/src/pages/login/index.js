    ...
    return (
        <>
            <div className="flex items-center justify-center h-screen bg-gray-100 font-manrope">
                <div className="flex flex-col lg:flex-row w-full h-full screen ">
                    ...
                    <div className="flex flex-col justify-between w-full lg:w-1/2 bg-white p-8">
